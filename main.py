...
def run(args):
    ...
    rambo_defects4j_examples = load_test_dataset(args, "rambo", "defects4j")
    ...
    all_eval_examples = {
        ...
        "rambo_defects4j": rambo_defects4j_examples
    }
    ...
    if args.eval:
        ...
        for name, examples in all_eval_examples.items():
            ...
            if args.enable_generation:
                ...
                elif name == "rambo_defects4j":
                    results = compute_metric_stmt(f"{args.output_dir}/{name}", "data/rambo/defects4j/test.jsonl", language="java", ts_lib="utils/build/java-lang-parser.so")
